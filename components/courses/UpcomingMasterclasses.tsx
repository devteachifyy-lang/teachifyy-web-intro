                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
                    ...
                    <div className="flex-1 w-full lg:max-w-xl">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-400 text-lg sm:text-lg mb-8 max-w-lg leading-relaxed">
                        ...
                        <div className="flex flex-col gap-4 w-full">
                            {/* Card 1 */}
                            <Link href="#" className="flex p-4 rounded-xl border border-white/10 items-center justify-between group bg-white dark:bg-dark-800">
                                <div>
                                    <div className="text-dark-900 dark:text-gray-100 font-bold mb-2 text-xl">How to move from B.ed to Dubai Classrooms</div>
